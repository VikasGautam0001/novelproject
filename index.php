...
<body>
    ...
    <div>
        ...
        <div id="Novels" class="tabcontent">
                <div class="latest_novels section">
                    <div class="top">
                        <h2 class="heading">Latest</h2> 
                        <div class="button">
                            <a href="">See all <span class="icon"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                        </div>
                    </div>
                    <div class="bottom">
                        <div class="outer_bottom">
                        <div class="inner_bottom1">
                        <div class="item"><a href=""><img src="default.jfif" alt="gojo" ><p>Gojo</p><span><i class="fa fa-heart" aria-hidden="true"></i></span></a></div>
                        <div class="item"><a href=""><img src="default.jfif" alt="gojo" ><p>Gojo</p><span><i class="fa fa-heart" aria-hidden="true"></i></span></a></div>
                        </div>
                ...
                <div class="most_popular_novels section">
                    <div class="top">
                ...
                <div class="genres_novels section">
                    <div class="top">
